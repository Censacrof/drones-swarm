...
if __name__ == '__main__':
    ...
    parser.add_argument('-W', '--world-width', type=int, default=352, help='Width of the world in patches (min is 50)')
    parser.add_argument('-H', '--world-height', type=int, default=352, help='Width of the world in patches (min is 50)')
